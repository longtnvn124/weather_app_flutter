...
import 'package:weather_app/page/detail_page.dart';

import '../models/Weather_item.dart';
import '../models/constrants.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  static String API_KEY =
      '3c75a7508a9a487b8a282734221509'; //Paste Your API Here

  String location = 'Thai Nguyen'; //Default location
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        WeatherItem(
                          value: cloud.toInt(),
                          unit: "%",
                          imageUrl: "assets/lightcloud.png",
                        ),
                      ],
                    ),
                  ),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  Text(
                                    forecastTemperature.toString() + "°C",
                                    style: TextStyle(
                                      color: _constants.greyColor,
                                      fontSize: 17,
                                      fontWeight: FontWeight.w600,
